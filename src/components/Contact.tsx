          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-slate-300 text-lg leading-relaxed mb-8 transition-colors duration-300">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="text-gray-900 dark:text-white font-semibold transition-colors duration-300">E-posta</h4>
                    <p className="text-gray-600 dark:text-slate-300 transition-colors duration-300">{personalInfo.email}</p>
                    {personalInfo.secondaryEmail && (
                      <p className="text-gray-600 dark:text-slate-300 transition-colors duration-300">{personalInfo.secondaryEmail}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="text-gray-900 dark:text-white font-semibold transition-colors duration-300">Konum</h4>
                    <p className="text-gray-600 dark:text-slate-300 transition-colors duration-300">{personalInfo.location}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Contact Form */}
            <div className="bg-white dark:bg-slate-700 p-8 rounded-2xl border border-gray-200 dark:border-transparent transition-colors duration-300">
              {hasSucceeded ? (
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      defaultValue=""
                      required
                      className="w-full px-4 py-3 bg-gray-100 dark:bg-slate-600 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all duration-200"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 bg-gray-100 dark:bg-slate-600 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all duration-200 resize-none"
